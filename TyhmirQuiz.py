...
A: mistake in code. things like spelling, grammer, puncuation

#5. What is a variable? Provide an example of a vari

a variable is a container for data. things that could be a variable is age, country of birth sex, and more others
...
# = // single equal-  an assignment operator used to assign the value to the variable
# == // double equal
# != // exclaimation equal
