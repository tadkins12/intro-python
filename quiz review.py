...
'complexity is the measure of resource inensive a program can anstructive os the process of hidong/ masking complexity'

#4. What does it mean when you encounter a syntax error?

'when your not speaking t m he computers lauguge
+'
